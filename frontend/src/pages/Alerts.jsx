...
import { AlertTriangle, Loader2, X, Check, CheckCircle, Filter, ChevronDown, ChevronUp, Search, Cpu, FileText, Clock, Bell } from 'lucide-react';
                                    ...
                                    {status === 'active' && (
                                        <>
                                            <button
                                                ...
                                                className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg bg-purple-50 px-3 py-2 text-sm font-medium text-purple-700 hover:bg-purple-100 transition-colors disabled:opacity-50 border border-purple-200"
                                                disabled={acknowledgeMutation.isLoading}
                                            >
                                                <Bell className="h-4 w-4" />
                                                {t('alerts.acknowledge', 'Ack')}
                                            </button>
                                            <button
